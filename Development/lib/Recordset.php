...
class Recordset
{
	...
	var $foreignValues = array(); //values of the fields that do not belong to the main table being accessed
         ...
         * @param string $query     For complex queries, the user must specify the query. If the query is specified then the id parameter is ignored and will not be used to retrieve data
         */
